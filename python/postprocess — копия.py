...
# Карта: ключевое слово в заголовке 1-го столбца -> имя типа таблицы
TABLE_TYPE_KEYWORDS = {
    "ток":     "AnalogueTable",
    "сигнал":  "DiscreteTable",
}

# Карта: (тип, число столбцов) -> список ширин в процентах (сумма = 100)
TABLE_WIDTHS_PCT = {
    ("AnalogueTable", 10): [8, 8, 8, 8, 8, 8, 8, 8, 8, 28],
    ("AnalogueTable", 7):  [10, 10, 10, 10, 10, 10, 40],
